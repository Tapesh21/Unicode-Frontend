  ...
  return (
    <div className="bg-white  lg:px-20" >
      <div className="pt-6">
        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10px-4 pt-10'>
          {/* Image gallery */}
          ...
          <div className="lg:col-span-1 mx-auto max-w-2xl px-4 pb-16 sm:px-6  lg:max-w-7xl  lg:px-8 lg:pb-24">
            <div className="lg:col-span-2">
              <h1 className="text-lg lg:text-xl font-semibold tracking-tight text-gray-900 ">unicode</h1>
              <h1 className="text-lg lg:text-xl tracking-tight text-gray-900 opacity-60 pt-1">
                unicode raisoni shirt
              </h1>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">378 Reviews</p>
                </div>
              </div>
              ...
              <form className="mt-10">
                ...
                <Button
                  ...
                  variant="contained"
                  type="submit"
                  sx={{ padding: ".8rem 2rem", marginTop: "2rem", bgcolor: "#8e2de2" }}
                >
                  Add To Cart
                </Button>
              </form>
